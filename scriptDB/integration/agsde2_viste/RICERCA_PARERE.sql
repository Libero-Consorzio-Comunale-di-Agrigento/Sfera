...
--changeset rdestasio:install_20210221_viste_05 runOnChange:true
...
AS
   SELECT -- dati identificativi del documento
          ...
          CAST ('PARERE' AS VARCHAR (255))       AS TIPO_DOCUMENTO,
          vp.id_determina                       AS ID_DOCUMENTO_PRINCIPALE,
          CAST (decode(deli.id_delibera, null, 'PROPOSTA_DELIBERA', 'DELIBERA') AS VARCHAR (255))   AS TIPO_DOCUMENTO_PRINCIPALE,
          vp.ente                               AS ENTE,
          ...
          -- corte dei conti
          CAST (nvl(deli.da_inviare_corte_conti, dete.da_inviare_corte_conti) AS CHAR (1))   AS DA_INVIARE_CORTE_CONTI,
          ...
          vp.data_ordinamento           AS DATA_ORDINAMENTO,
