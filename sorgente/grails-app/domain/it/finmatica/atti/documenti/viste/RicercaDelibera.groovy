...
class RicercaDelibera extends RicercaDocumento {

	OggettoSeduta 	oggettoSeduta
	Commissione		commissione
	Long 			idTipoAllegatoDelibera
	Long 			idTipoAllegatoParere
	As4SoggettoCorrente relatore
