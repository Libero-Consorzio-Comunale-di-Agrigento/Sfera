...
class RicercaCertificato extends RicercaDocumento {
	...
	static mapping = {
		...
		columns {
			...
			unitaRedazione {
				column name: 'uo_redazione_progr'
				column name: 'uo_redazione_dal'
				column name: 'uo_redazione_ottica'
			}
