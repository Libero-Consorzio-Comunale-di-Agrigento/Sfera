...
class CategoriaDeterminaDettaglioViewModel extends AfcAbstractRecord {
    ...
    @Init init(@ContextParam(ContextType.COMPONENT) Window w, @ExecutionArgParam("id") Long id) {
		...
		if (id != null) {
			...
			selectedRecord = new CategoriaDTO(valido:true, sequenza:1, tipoOggetto:Categoria.TIPO_OGGETTO_DETERMINA)
		}
    }
			...
			new org.zkoss.zk.ui.event.EventListener() {
				...
				public void onEvent(Event e){
					if(Messagebox.ON_OK.equals(e.getName())) {
						...
						onSalva()
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaDettaglioViewModel.this, "selectedRecord")
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaDettaglioViewModel.this, "datiCreazione")
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaDettaglioViewModel.this, "datiModifica")
				...
				new org.zkoss.zk.ui.event.EventListener() {
					public void onEvent(Event e) {
						if (org.zkoss.zhtml.Messagebox.ON_OK.equals(e.getName())) {
							...
							caricaAllegatiObbligatori()
							BindUtils.postNotifyChange(null, null, CategoriaDeterminaDettaglioViewModel.this, "listaAllegatiObbligatori")
							BindUtils.postNotifyChange(null, null, CategoriaDeterminaDettaglioViewModel.this, "selectedRecord")
						}
					}
				});
