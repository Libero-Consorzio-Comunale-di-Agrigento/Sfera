...
class CategoriaDeterminaListaViewModel extends AfcAbstractGrid{
	...
	@Command onModifica (@BindingParam("isNuovoRecord") boolean isNuovoRecord) {
		...
		Window w = Executions.createComponents ("/dizionari/atti/categoriaDeterminaDettaglio.zul", self, [id: idCategoria])
		w.onClose {
			activePage 	= 0
			caricaListaCategoria()
				...
				public void onEvent(Event e){
					if(Messagebox.ON_OK.equals(e.getName())) {
						...
						if(listaCategoria.size() == 1){
							CategoriaDeterminaListaViewModel.this.activePage= CategoriaDeterminaListaViewModel.this.activePage==0?0:CategoriaDeterminaListaViewModel.this.activePage-1
						}
						categoriaDTOService.elimina(CategoriaDeterminaListaViewModel.this.selectedRecord)
						CategoriaDeterminaListaViewModel.this.selectedRecord = null
						CategoriaDeterminaListaViewModel.this.caricaListaCategoria()
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaListaViewModel.this, "activePage")
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaListaViewModel.this, "listaCategoria")
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaListaViewModel.this, "totalSize")
						BindUtils.postNotifyChange(null, null, CategoriaDeterminaListaViewModel.this, "selectedRecord")
