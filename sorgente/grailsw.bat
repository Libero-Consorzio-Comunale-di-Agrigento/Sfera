...
@rem Personalizzazione dei parametri di lancio di grails:
set GRAILS_OPTS=-server -Xmx1G -Xms1G -Dfile.encoding=UTF-8
...
if "x%GRAILS_AGENT_CACHE_DIR%" == "x" set GRAILS_AGENT_CACHE_DIR=%SHORTHOME%/.grails/2.5.4/
...
set STARTER_CLASSPATH=wrapper/grails-wrapper-runtime-2.5.4.jar;wrapper;.
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.5.4
